...
export const NoticeCard = ({ notice, departmentId }: NoticeCardProps) => {
  return (
    <Link
      ...
      className="group flex h-[300px] w-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white transition-all hover:-translate-y-1 hover:border-[#2046FF]/30 hover:shadow-lg hover:shadow-[#2046FF]/10"
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
          ...
          <button className="text-slate-300 transition-colors hover:text-[#2046FF]">
            <Bookmark
              size={16}
